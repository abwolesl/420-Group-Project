...
public class Test extends Application {
	...
	public void start(Stage fxStage) throws InterruptedException {
		Group g = new Group();
		fxStage.setTitle("This is my FX project");
		Scene fxScene = new Scene(g, screenWidth * .9, screenHeight * .9);
		fxStage.setScene(fxScene);
		
		Button b = new Button("Update Line");
		g.getChildren().add(b);
		...
		eYL.setLayoutY(385);
		endY.setLayoutY(400);
		g.getChildren().addAll(startX,startY,endX,endY);
