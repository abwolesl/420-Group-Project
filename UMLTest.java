...
public class UMLTest extends Application {
	...
	private void createLineOptions(VBox optionsVBox, Scene drawingScene, Group group) {
		...
		lineOptions.getItems().addAll("Solid Line", "Dotted Line", "Bold Line", "Aggregation", "Composition", "Generalization", "Dependency", "UpdateGeneralization");
			...
			if (isLineBeingDrawn == true) {
				...
				switch (option){
					...
					case "Composition":
						...
						break;
					case "Generalization":
						Generalization g = new Generalization(startingPointX, startingPointY, currentEndingPointX, currentEndingPointY);
						g.drawMe(group);
