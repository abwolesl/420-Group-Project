...
public class Testing {
	...
	public void testAggregation() {
		...
		// Initialization
		Relationship agg = new Relationship(testGroup, "Aggregation", 100, 200, 300, 400);
	...
	public void testComposition() {
		...
		// Initialization
		Relationship comp = new Relationship(testGroup, "Composition", 100, 200, 300, 400);
	...
	public void testGeneralization() {
		...
		// Initialization
		Relationship gen = new Relationship(testGroup, "Generalization", 100, 200, 300, 400);
	...
	public void testDependency() {
		...
		// Initialization
		Relationship depend = new Relationship(testGroup, "Dependency", 100, 200, 300, 400);
	...
	public void testBackwardsDraw() {
		...
		Group testGroup = new Group();
		Relationship depend = new Relationship(testGroup, "Dependency", 400, 300, 200, 100);
		assertTrue("Relationship type matches input param", depend.getRelType().equals("Dependency"));
