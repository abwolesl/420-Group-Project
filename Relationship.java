...
public class Relationship extends Line {
	...
	public Relationship(Scene UMLScene, Group group,String relationshipType, double startX, double startY, double endX, double endY) {
		relType = relationshipType;
	...
	public String whereAmI() {
		return("Relationship/" + relType +"/" + startXValue + "/" 
			   + startYValue +"/" + endXValue + "/" + endYValue + "  -" );
	}
}
